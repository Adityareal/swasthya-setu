...
const hiIN: Record<keyof typeof enIN, string> = {
  ...
  /* ——— बिना नेटवर्क वाला नतीजा और असफल ए.आई. कॉल — दोनों अलग बातें हैं। ——— */
  'chat.offline':
    'नेटवर्क नहीं है। यह नतीजा आपके लिखे शब्दों से, इसी फ़ोन पर बना है।',
  'chat.error.title': 'आकलन पूरा नहीं हुआ',
  'chat.error':
    'ए.आई. आकलन नहीं आ सका। आपके जवाब सुरक्षित हैं — फिर कोशिश करें।',
  'chat.error.reason.timeout': 'स्वास्थ्य सहायक ने जवाब देने में बहुत देर लगाई।',
  'chat.error.reason.error': 'स्वास्थ्य सहायक तक पहुँच नहीं हो सकी।',
  'chat.error.reason.unparseable': 'स्वास्थ्य सहायक का जवाब पढ़ा नहीं जा सका।',
  'chat.error.reason.no-key': 'इस तैनाती पर ए.आई. स्वास्थ्य सहायक सेट नहीं है।',
